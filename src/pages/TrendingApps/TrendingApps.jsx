...
const TrendingApps = ({apps}) => {
    ...
    return (
        <div className='text-center py-13 px-6'>
            ...
            <div className='grid md:grid-cols-4 grid-cols-2 gap-4'>
             ...
             <button onClick={() => navigate('/allapps')} className="btn bg-linear-to-br from-[#632EE3] to-[#9F62F2] text-[#FFFFFF] mt-7 px-5">Show All</button>
