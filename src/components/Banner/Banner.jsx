...
const Banner = () => {
    return (
        <div className='flex flex-col bg-[#f8f6f6] text-center pt-10'>
            <h1 className='font-bold text-[#001931] text-5xl mb-3.5'>We Build <br /> <span className='bg-linear-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent'>Productive</span> Apps</h1>
